 ...
 * @version CVS $Id: MP3DirectoryGenerator.java 433543 2006-08-22 06:22:54Z crossley $
 */
public class MP3DirectoryGenerator extends DirectoryGenerator
{
    ...
    // Attributes
    protected final static String MP3_FREQUENCY_ATTR_NAME = "frequency";
    protected final static String MP3_BITRATE_ATTR_NAME   = "bitrate";
    protected final static String MP3_MODE_ATTR_NAME      = "mode";
    protected final static String MP3_VBR_ATTR_NAME   = "variable-rate";

    protected final static String MP3_TITLE_ATTR_NAME   = "title";
    protected final static String MP3_ARTIST_ATTR_NAME = "artist";
    protected final static String MP3_ALBUM_ATTR_NAME   = "album";
    protected final static String MP3_YEAR_ATTR_NAME    = "year";
    protected final static String MP3_COMMENT_ATTR_NAME = "comment";
    protected final static String MP3_TRACK_ATTR_NAME   = "track";
    protected final static String MP3_GENRE_ATTR_NAME   = "genre";
